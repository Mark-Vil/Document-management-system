...
<li class="nav-item">
    ...
    <ul id="submissions-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
        <li>
        <a href="mysubmission.php" class="active">
...
if ($submission['status'] == 'Accepted' || $submission['status'] == 'Locked') {
    ...
    if ($submission['status'] == 'Accepted') {
        echo "<li><button class='dropdown-item btn btn-info lock-btn' data-id='" . htmlspecialchars($submission['id']) . "'>Lock</button></li>";
    } elseif ($submission['status'] == 'Locked') {
        echo "<li><button class='dropdown-item btn btn-info unlock-btn' data-id='" . htmlspecialchars($submission['id']) . "'>Unlock</button></li>";
    }
...
echo "</td>";
        ...
        echo "<tr><td colspan='6' class='text-center'>No submissions yet</td></tr>";
    }
    ?>
</tbody>
      </table>
