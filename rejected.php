...
include 'php-functions/fetch-mysubmission.php';
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Rejected Submissions</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<tbody>
    <?php
    if ($submissions) {
        $hasVisibleSubmissions = false;
        foreach ($submissions as $submission) {
            // Skip submissions with status Accepted or Locked
            if ($submission['status'] == 'Accepted' || $submission['status'] == 'Locked') {
                continue;
            }
            
            $hasVisibleSubmissions = true;
            echo "<tr>";
        ...
        if (!$hasVisibleSubmissions) {
            echo "<tr><td colspan='7' class='text-center'>No rejected submissions to display</td></tr>";
        }
    } else {
        echo "<tr><td colspan='7' class='text-center'>No rejected submissions yet</td></tr>";
    }
    ?>
</tbody>
      </table>
