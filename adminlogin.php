    ...
    letter-spacing: 0.1px;">WESTERN MINDANAO STATE UNIVERSITY</h3>
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color:rgb(44, 43, 43); font-family: __esbuild_b38aaf, __esbuild_Fallback_b38aaf, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace; font-weight: 600;">ADMIN</p>

                  <form id="admin-account-login" class="mx-1 mx-md-4">
...
<script src="Admin/static/js/admin-account.js"></script>
</body>
