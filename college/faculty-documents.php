    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="dashboard-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
          <li>
            <a href="faculty-documents.php" class="active">
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Submissions Per Faculty/Course</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<style>
  ...
  <script src="static/js/faculty-documents.js"></script>
