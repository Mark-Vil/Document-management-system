...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <canvas id="acceptedSubmissionsChart"></canvas>
        </div>    


        <div class="col-lg-6 mt-2">
        <canvas id="pendingSubmissionsChart" width="100" height="100"></canvas>
        </div>    
    ...
    <div class="col-lg-6 mt-2">
        <select id="filterSelect" class="form-select mb-3">
            <option value="most_search">Most Search</option>
            <option value="most_views">Most Views</option>
            <option value="most_downloads">Most Downloads</option>
            <option value="most_cite">Most Cite</option>
        </select>
        <canvas id="facultyviewsChart"></canvas>
    </div>
</div> -->

            </div>
            <input type="hidden" id="collegeCode" value="<?php echo htmlspecialchars($_SESSION['college_code']); ?>">
            
            <div style="border: 2px solid #943f3f; border-radius: 10px; padding: 10px; max-height: 300px; overflow-y: auto;">
  ...
  <script src="static/js/faculty-submissions.js"></script>
