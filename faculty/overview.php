...
$sessionSet = isset($_SESSION['email']) && isset($_SESSION['role']) && isset($_SESSION['faculty_id']);
// Redirect to login page if faculty_id is not set
...
$isVerified = false;
if ($sessionSet && isset($_SESSION['faculty_id'])) {
...
<body>
      ...
      <div class="list-menu" style="z-index: 1000; border-color: white;">
        ...
        <nav id="navbar" class="navbar justify-content-center">
          <ul>
            ...
            <li><a class="nav-link scrollto active" href="logged-in.php">Research Content</a></li>
            <?php if ($sessionSet): ?>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="about" class="about-section" style="margin-top: 50px;">
   ...
   <div class="row">
    <?php foreach ($colleges as $college): ?>
      <div class="col-lg-3 mb-3">
        <div class="visit-college">
            <?php 
            // Encrypt the college code
            $encrypted_college_code = encrypt($college['college_code']);
            // Set default image if no image_path
            $imagePath = !empty($college['image_path']) ? $college['image_path'] : 'static/img/wmsu-crop.jpg';
            ?>
            <a href="college-view.php?code=<?php echo $encrypted_college_code; ?>">
                <img src="<?php echo htmlspecialchars($imagePath); ?>" class="card-img-top circle-image" alt="<?php echo htmlspecialchars($college['college_name']); ?>">
                <div class="card-body">
                    <h6 class="card-title"><?php echo htmlspecialchars($college['college_name']); ?></h6>
                </div>
            </a>
        </div>
    </div>
