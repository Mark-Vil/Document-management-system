...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapse" data-bs-target="#colleges" data-bs-toggle="collapse" href="#">
          <i class="bi bi-building"></i><span>College Documents</span><i class="bi bi-chevron-down ms-auto"></i>
        </a> 
        <ul id="colleges" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
          <li>
            <a href="department-faculty.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Colleges & Faculty</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
              <div class="faculty" style="padding: 10px; border: 1px solid #943f3f; border-radius: 10px;">
        <div class="row mb-3">
          <div class="col-md-8">
      ...
      <!-- Search input and Choose Year selection end -->
                ...
                <table class="table table-striped" >
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Total Document</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Document details will be populated here by JavaScript -->
                </div>
    ...
    <div class="modal fade" id="infoModal" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="infoModalLabel">Document Information</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Full document information will be populated here by JavaScript -->
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                </div>
            ...
            <div class="card-body" style="width: 350px; height: 350px;">
              <div class="d-flex align-items-center mb-2">
                <select id="yearFilterchart" class="form-select" style="border-color: #943f3f; width: 200px;" >
  ...
  <script src="static/js/college&faculty-documents.js"></script>
