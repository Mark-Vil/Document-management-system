...
<body>
      ...
      <li class="nav-item">
        ...
        <ul id="facultyaccount-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
          <li>
            ...
            <a href="faculty-accounts-accepted.php"  class="active">
        ...
        <div class="col-lg-12">
          ...
          <div class="form-group mb-4">
            ...
            <table class="table table-striped">
              ...
              <tbody id="adviserAccountsTableBodyaccepted">
              </tbody>
            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewModalLabel">Adviser Details</h5>
  ...
  <script src="static/js/faculty-accounts-accepted.js"></script>
