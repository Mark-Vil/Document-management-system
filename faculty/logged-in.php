...
if (!isset($_SESSION['email']) || !isset($_SESSION['role']) || !isset($_SESSION['faculty_id'])) {
...
.search-results-border {
    ...
    <form id="search-form" method="GET" action="search.php">
      <input type="search"  type="search" name="search" id="search-input" class="search-input" style="width: 500px; border-radius: 10px; height: 40px; border: 0; outline: none;" placeholder="Search for title, asbtract, author, date or keywords">
    </form>
...
?>
    ...
    <!-- ======= Latest Section ======= -->
<section id="about" class="about about-latest" style="<?php echo $userId && hasUserInteractions($userId) ? '' : 'margin-top: 150px!important;'; ?>">
  <div class="container" data-aos="fade-down">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="mr-4 mb-4">Latest</h1>
      </div>
    </div>
  </div>
  <div class="container" data-aos="fade-down">
