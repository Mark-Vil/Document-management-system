    ...
    <ul id="dashboard-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="history-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="verification-history.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <ol class="breadcrumb d-flex">
          <div class="d-flex">
            ...
            <li class="breadcrumb-item active">Verification History</li>
          </div>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <table class="table verification-history table-striped">
            <thead>
                <tr>
                    <th scope="col"></th>
