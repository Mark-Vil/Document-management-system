...
<body>
  ...
  <div class="container">
    ...
    letter-spacing: 0.1px;">
                ...
                <h5 style="color: white; font-family: __esbuild_b38aaf, __esbuild_Fallback_b38aaf, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace; font-size: 14px; margin: 0; font-weight: 600; letter-spacing: 1px;">
                    RESEARCH REPOSITORY
                </h5>
            </div>
        </div>
...
.search-results-border {
  ...
  <form id="search-form" method="GET" action="search.php">
   <input type="search" name="search" id="search-input" class="search-input" style="width: 500px; border-radius: 10px; height: 40px; border: 0; outline: none;" placeholder="Search for title, abstract, author, date or keywords">
</form>
...
<section id="about" class="about about-latest" style="<?php echo $userId && hasUserInteractions($userId) ? '' : 'margin-top: 150px!important; max-height: 1200px'; ?>">
  <div class="container" data-aos="fade-down">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="ml-3 mb-4" style="font-family: __esbuild_b38aaf, __esbuild_Fallback_b38aaf, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace; font-weight: 600px;">Latest</h1>
      </div>
    </div>
  </div>
  <div class="container" data-aos="fade-down">
    ...
    <div class="row latest" style="min-height: 800px;">
    </div>
  </div>
</section>
