    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="list-menu" style="z-index: 1000; border-color: white;">
            ...
            <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="content.php">Find Documents</a></li>
                    <?php if ($sessionSet): ?>
...
.search-results-border {
  ...
  <div class="search-field d-flex justify-content-center align-items-center mb-2">
    ...
    <form id="search-form" method="GET" action="javascript:void(0);">
      ...
      <input type="search"  type="search" name="search" id="search-input" class="search-input" style="width: 500px; border-radius: 10px; height: 40px; border: 0; outline: none;" placeholder="Search for title, abstract, author or keywords">
