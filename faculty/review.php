...
if ($submissions) {
    foreach ($submissions as $submission) {
        ...
        echo "<li><button class='dropdown-item btn btn-success approve-btn' data-id='" . htmlspecialchars($submission['submission_id']) . "'>Approve</button></li>";
        echo "<li><button class='dropdown-item btn btn-danger revise-btn' data-id='" . htmlspecialchars($submission['submission_id']) . "'>Revise</button></li>";
        echo "<li><button class='dropdown-item btn btn-danger reject-btn' data-id='" . htmlspecialchars($submission['submission_id']) . "'>Reject</button></li>";
    ...
    echo "<tr><td colspan='6' class='text-center'>No pending student submissions</td></tr>";
}
?>
          </tbody>
        </table>
