...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapse" data-bs-target="#department-information-nav" data-bs-toggle="collapse" href="">
          <i class="bi bi-file-text"></i><span>Department</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="department-information-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
          <li>
            <a href="faculty-information.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Faculty Information</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="col-lg-12 mb-4">
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adddepartmentCodeModal">Add</button>
              </div>
        ...
        <div class="col-lg-4">
        <canvas id="usersPerFacultyChart"></canvas>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editDepartmentForm">
          <input type="hidden" id="edit_department_code_original">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="edit_department_code" required>
          </div>
        </form>
      </div>
...
`
      ...
      <!-- ======= ADD DEPARTMENT CODE MODAL ======= -->
      <div class="modal fade" id="adddepartmentCodeModal" tabindex="-1" aria-labelledby="adddepartmentCodeModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="adddepartmentCodeModalLabel">Add Department</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
              <form id="adddepartmentCode">
    <div class="mb-3">
  ...
  <script src="static/js/college-account.js"></script>
  <script src="static/js/department-faculty-graph.js"></script>
